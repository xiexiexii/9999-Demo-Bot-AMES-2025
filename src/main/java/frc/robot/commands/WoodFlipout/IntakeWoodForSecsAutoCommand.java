...
public class IntakeWoodForSecsAutoCommand extends Command{
    ...
    public IntakeWoodForSecsAutoCommand(WoodIntakeSubsystem woodIntakeSubsystem, double seconds) {
    ...
    public void execute() {
      m_woodIntakeSubsystem.intakeAuto();
    }
